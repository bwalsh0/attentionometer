...
const bot = new TeleBot({
    token: '546954862:AAHwMjxXtmiDkMhyl9iyoWgUhtUsPEzCJJA', // Required. Telegram Bot API token.
    ...
    webhook: { // Optional. Use webhook instead of polling.
        ...
        maxConnections: 3 // Optional. Maximum allowed number of simultaneous HTTPS connections to the webhook for update delivery
    },
